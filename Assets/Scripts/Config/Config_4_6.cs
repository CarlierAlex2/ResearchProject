...
public class AgentConfig_4_6
{
    public static bool hasInstance = false;
    private static AgentConfig_4_6 instance;
    public static AgentConfig_4_6 Instance
    {
        get 
        {
            if (!hasInstance)
    ...
    //--
    public float CHECKPOINT_OFFSET { get { return 1f; } }
    //--
    public float CHECKPOINT_RANGE { get { return 2.3f; } }
...
public class RewardConfig_4_6
{
    public static bool hasInstance = false;
    private static RewardConfig_4_6 instance;
    public static RewardConfig_4_6 Instance
    {
        get 
        {
            if (!hasInstance)
    ...
    //--
    public float TIME { get { return -0.2f; } }
