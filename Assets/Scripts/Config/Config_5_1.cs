...
public class AgentConfig_4_9
{
    public static bool hasInstance = false;
    private static AgentConfig_4_9 instance;
    public static AgentConfig_4_9 Instance
    {
        get 
        {
            if (!hasInstance)
...
public class RewardConfig_4_9
{
    public static bool hasInstance = false;
    private static RewardConfig_4_9 instance;
    public static RewardConfig_4_9 Instance
    {
        get 
        {
            if (!hasInstance)
    ...
    //--
    public float TIME { get { return -0.1f; } }
