...
public class AgentConfig_4_4
{
    public static bool hasInstance = false;
    private static AgentConfig_4_4 instance;
    public static AgentConfig_4_4 Instance
    {
        get 
        {
            if (!hasInstance)
...
public class RewardConfig_4_4
{
    public static bool hasInstance = false;
    private static RewardConfig_4_4 instance;
    public static RewardConfig_4_4 Instance
    {
        get 
        {
            if (!hasInstance)
