...
public class CarAgent6 : Agent
{
    ...
    //mlagents-learn config/PPO/PPO_CarAgent6_batchsize.yaml --run-id=PPO_6_5_angle_120_none --env=builds/PPO_CarAgent6_multi
    //mlagents-learn config/PPO/PPO_CarAgent6_batchsize.yaml --run-id=PPO_6_5_angle_120_neg --env=builds/PPO_CarAgent6_multi_2
    ...
    //mlagents-learn config/SAC/SAC_03_entcoef.yaml --run-id=SAC_03_entcoef --env=builds/SAC_CarAgent6_multi
    //mlagents-learn config/SAC/SAC_04_learningRate.yaml --run-id=SAC_04_learningRate --env=builds/SAC_CarAgent6_multi
